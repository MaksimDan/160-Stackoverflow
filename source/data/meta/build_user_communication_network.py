...
def build_user_communication_df(base_path, _indent=False):
    ...
    """
    Posts = pd.read_csv(base_path + 'Posts.csv', dtype={'LastEditorDisplayName': str})
    Comments = pd.read_csv(base_path + 'Comments.csv', dtype={'LastEditorDisplayName': str})
...
if __name__ == "__main__":
    build_user_communication_df('../../160-Stackoverflow-Data/train_test/raw_query/')
